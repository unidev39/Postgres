...
# File          : Standalone_Postrges_17_Differential_Base_Backup.sh
# Purpose       : To Take a Base Full and Differential Incremental Backup on Postgres 17
# Usage         : ./Standalone_Postrges_17_Differential_Base_Backup.sh
# Created By    : Devesh Kumar Shrivastav
# Created Date  : January 01, 2025
# Revision      : 1.0
###########################################################################################################
#######BOF This is part of the Standalone_Postrges_17_Differential_Base_Backup.sh##########################
...
exit
###########################################################################################################
#######EOF This is part of the Standalone_Postrges_17_Differential_Base_Backup.sh##########################